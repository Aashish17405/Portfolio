...
export default function ProjectsSection() {
  ...
  //     },
  //     projectUrl:
  //       "https://siteease.dev-aashish.tech",
  //     githubUrl: "https://github.com/Aashish17405/SiteEase",
  //     theme: "#009689",
  //     gradient_from: "#009689",
  //     gradient_via: "#007a6d",
  //     gradient_to: "#007a6d",
  //   },
  //   {
  ...
  const projects: Project[] = [
    {
      ...
      projectUrl: "https://wealthwisee.live/",
      githubUrl:
        "https://github.com/Aashish17405/WealthWise-Backend",
      theme: "#28418f",
  ...
  return (
    <section className="relative pt-12 bg-gray-950">
      <div className="section-content">
        <div className="flex items-center justify-between mb-12">
          ...
          <TextScrambleLoop
            text="Stuff I Built"
            className="absolute left-1/2 transform -translate-x-1/2 text-white text-4xl font-bold"
          />
        </div>
